      ...
      <div className={toggleModal}>
        <div className="modal">
          ...
          <aside className="modal__info">
            ...
            red curry tofu noodles enchiladas winter Bolivian rainbow pepper
            green grapes farro platter paprika green tea cranberry spritzer
            chocolate peanut butter dip Caribbean red habanero cinnamon toast
            leek mediterranean luxury bowl main course fruit smash salad bite
            sized tofu burritos. Simmer roasted peanuts oranges garlic sriracha
            noodles pine nuts peaches artichoke hearts thyme creamy cauliflower
            alfredo sauce apple vinaigrette green onions earl grey latte rich
            coconut cream shallots roasted brussel sprouts portobello mushrooms
            elderberry overflowing coconut milk frosted gingerbread bites.{" "}
          </aside>
        </div>
      </div>
    </>
